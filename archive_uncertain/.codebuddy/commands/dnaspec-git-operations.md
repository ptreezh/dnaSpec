...
## Description
Setup Git constitution and rules to prevent AI file pollution in projects
...
/dnaspec.git-operations "operation=smart-commit project_path=. message='[DNASPEC] Add AI-validated feature'"
