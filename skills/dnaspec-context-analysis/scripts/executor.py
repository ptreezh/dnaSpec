...
from .validator import ContextAnalysisValidator
from .calculator import ContextAnalysisCalculator
from .analyzer import ContextAnalysisAnalyzer
...
class ContextAnalysisExecutor:
    def __init__(self, skill_dir: Optional[Path] = None):
        ...
        self.validator = ContextAnalysisValidator()
        self.calculator = ContextAnalysisCalculator()
        self.analyzer = ContextAnalysisAnalyzer()
