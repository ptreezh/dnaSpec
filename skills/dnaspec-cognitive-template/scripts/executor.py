...
from .validator import CognitiveTemplateValidator
from .calculator import TemplateCalculator
...
class TemplateExecutor:
    def __init__(self, skill_dir: Optional[Path] = None):
        ...
        self.validator = CognitiveTemplateValidator()
        self.calculator = TemplateCalculator()
