...
from .validator import ContextOptimizationValidator
from .calculator import OptimizationCalculator
...
class OptimizationExecutor:
    def __init__(self, skill_dir: Optional[Path] = None):
        ...
        self.validator = ContextOptimizationValidator()
        self.calculator = OptimizationCalculator()
