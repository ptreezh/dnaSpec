...
class TempWorkspaceSkill(BaseSkill):
    ...
    def __init__(self):
        super().__init__(
            name="temp-workspace",
            description="Used to manage temporary files generated by AI, to avoid project chaos"
        )
        # Global variable to store current work session
    ...
    def _format_output(self, result_data: Dict[str, Any], detail_level: DetailLevel) -> Dict[str, Any]:
        ...
        if detail_level == DetailLevel.BASIC:
            ...
            # Add additional information for specific operations
    ...
    def add_file_to_temp_workspace(self, file_path: str, content: str) -> str:
        ...
        if not self.current_temp_workspace:
            return "Error: No temporary workspace created, please execute create-workspace operation first"
    ...
    def list_files_in_temp_workspace(self) -> str:
        ...
        """
        if not self.current_temp_workspace:
            return "Error: No temporary workspace created"
    ...
    def auto_manage_workspace(self) -> str:
        ...
        # Calculate temporary file count (excluding confirmed directory)
        temp_file_count = 0
        for root, dirs, filenames in os.walk(self.current_temp_workspace):
        ...
        if temp_file_count > self.max_temp_files:
            # Exceeds threshold, perform organization
            result = f"Temporary file count ({temp_file_count}) exceeds threshold ({self.max_temp_files}), recommend organization:\n"
