...
class ProgressiveDisclosureSkill(BaseSkill):
    """Progressive Disclosure Skill - Used to create project documentation directory structure based on progressive disclosure principle"""

    def __init__(self):
        super().__init__(
            name="progressive-disclosure",
            description="Used to create project documentation directory structure according to progressive disclosure principle based on user requirements"
        )
