...
class SystemArchitectSkill(BaseSkill):
    """System Architect Skill - For system architecture design, technology stack selection, module division and interface definition"""
    
    def __init__(self):
        super().__init__(
            name="system-architect",
            description="For complex project system architecture design, technology stack selection, module division and interface definition"
        )
        
        # Architecture indicators
        self.microservice_indicators = [
            'microservice', 'service decomposition', 'independent deployment', 'service governance', 'distributed',
        ...
        self.high_availability_indicators = [
            'high availability', 'highly available', 'fault tolerance', 'failover', 'redundancy',
    ...
    def _format_output(self, result_data: Dict[str, Any], detail_level: DetailLevel) -> Dict[str, Any]:
        ...
        if detail_level == DetailLevel.BASIC:
            ...
            return {
                ...
                "defined_interfaces": result_data["defined_interfaces"][:5],  # Return only top 5 interfaces
