...
def display_post_installation_guide():
    ...
    """
    print("=" * 80)
    print("🎉 DSGS Context Engineering Skills - POST-INSTALLATION GUIDE")
    print("=" * 80)
    print()
    print("Thank you for installing DSGS (Dynamic Specification Growth System)!")
    print()
    print("DSGS is a professional context engineering toolkit that enhances your AI-assisted")
    ...
    print("  /speckit.dsgs.context-analysis 'Analyze this requirement: ...'")
    print("  /speckit.dsgs.context-optimization 'Optimize this context: ...'")
    print("  /speckit.dsgs.cognitive-template 'Apply template to: ...' template=verification")
    print("  /speckit.dsgs.architect 'Design system for: ...'")
    print()
