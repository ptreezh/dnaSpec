# DSGS Gemini CLI Extensions 快速开始指南

## 简介

DSGS Gemini CLI Extensions 是一个为Gemini CLI设计的专业技能扩展系统，它提供了多种AI技能来帮助您进行系统架构设计、任务分解、智能体创建等工作。
...
```bash
# 进入项目目录
cd D:\DAIP\dnaSpec\DSGS-Project
...
### 系统设计工作流
1. 使用`dsgs-architect`设计整体架构
2. 使用`dsgs-task-decomposer`分解开发任务
3. 使用`dsgs-agent-creator`创建必要的智能体
4. 使用`dsgs-dapi-checker`验证接口设计
5. 使用`dsgs-modulizer`进行模块化评估

### 微服务开发工作流
1. 使用`dsgs-system-architect`设计具体服务
2. 使用`dsgs-task-decomposer`分解服务开发任务
3. 使用`dsgs-constraint-generator`生成服务约束
4. 使用`dsgs-dapi-checker`检查服务接口
5. 使用`dsgs-modulizer`评估服务成熟度
