...
```
上下文置信度: 0.99
项目名称: DSGS与spec.kit整合项目
项目目标: 创建一个既具备专业技能又支持多平台的AI辅助开发系统
项目范围: 集成DSGS技能系统与spec.kit跨平台支持能力
