...
def main():
    ...
    for html_file in html_files:
        # 跳过已经更新的文件
        if 'dnaspec-unified.css' in html_file.name:
            continue
        if 'navigation-template.html' in html_file.name:
            continue
        if 'README.html' in html_file.name:
            continue
        if 'update_html_files.py' in html_file.name:
            continue
