...
```bash
# .env.example
DNASPEC_CONTEXT_ENGINEERING_PORT=8000
DNASPEC_CONTEXT_ENGINEERING_HOST=0.0.0.0
DNASPEC_CONTEXT_ENGINEERING_DEBUG=false
DNASPEC_CONTEXT_ENGINEERING_LOG_LEVEL=INFO

# Performance settings
DNASPEC_CONTEXT_ENGINEERING_CACHE_SIZE=128
DNASPEC_CONTEXT_ENGINEERING_MAX_CONTEXT_LENGTH=50000
DNASPEC_CONTEXT_ENGINEERING_TIMEOUT=30

# Security settings
DNASPEC_CONTEXT_ENGINEERING_RATE_LIMIT=100
DNASPEC_CONTEXT_ENGINEERING_BURST_LIMIT=200
```
